...
class MobileNetV2(nn.Module):
    def __init__(self, pretrained=None, num_classes=1000, width_mult=1.0, in_channels=3):
...
def mobilenet_v2(pretrained=True, progress=True, **kwargs):
    ...
    if pretrained:
        ...
        for k, v in state_dict.items():
            if k == 'features.0.0.weight' and kwargs['in_channels'] != 3:
...
if __name__ == '__main__':
    model = mobilenet_v2(in_channels=32, pretrained=True)
    print(model)
